 ...
 * @brief Point d'entrée central pour l'exécution des commandes IRC.
 *
 * Cette classe reçoit une commande déjà parsée, vérifie les règles du
 * serveur et du canal, puis applique les changements sur les clients et
 * les canaux. Elle est la couche de logique métier qui décide si une
 * commande est autorisée ou rejetée.
 */
class CommandHandler
{
public:
